    ...
    <div className="flex flex-col min-h-dvh bg-[var(--color-bg-primary)]">
      ...
      <header className="px-[var(--space-6)] pt-[var(--space-8)] pb-[var(--space-6)] border-b border-[var(--color-border-light)]">
        <div className="flex items-center gap-[var(--space-3)] mb-[var(--space-1)]">
          ...
          <h1 className="text-[var(--text-2xl)] font-black text-[var(--color-text-primary)]">Ayuda</h1>
        </div>
      </header>
      ...
      <main className="flex-1 pb-32">
        ...
        {FAQ.map(section => (
          <section key={section.category} className="mb-[var(--space-2)]">
            <p className="px-[var(--space-6)] pt-[var(--space-6)] pb-[var(--space-3)] text-[var(--text-xs)] font-bold text-[var(--color-text-muted)] uppercase tracking-[0.2em]">
              {section.category}
            </p>
                ...
                return (
                  <div key={key} className="border-b border-[var(--color-border-light)]">
                    <dt>
                      ...
                      >
                        <span className="text-[var(--text-base)] font-medium text-[var(--color-text-primary)] flex-1">
                          {item.q}
                        </span>
                        <svg
                    ...
                    {isOpen && (
                      <dd className="px-[var(--space-6)] pb-[var(--space-5)] text-[var(--text-sm)] text-[var(--color-text-secondary)] leading-relaxed animate-fade-in">
                        {item.a}
                      </dd>
                    )}
                  </div>
        ...
        <div className="mx-[var(--space-5)] mt-[var(--space-6)] bg-[var(--color-bg-secondary)] border border-[var(--color-border-light)] rounded-[var(--radius-2xl)] p-[var(--space-6)]">
          <p className="text-[var(--text-base)] font-bold text-[var(--color-text-primary)] mb-[var(--space-2)]">
            ¿No encontraste lo que buscabas?
          </p>
          <p className="text-[var(--text-sm)] text-[var(--color-text-tertiary)] mb-[var(--space-5)]">
            Escríbenos y te respondemos en menos de 24 horas.
          </p>
          <a
            href="mailto:soporte@elitemarket.co"
            className="inline-flex items-center gap-[var(--space-2)] bg-[var(--color-primary)] text-white text-[var(--text-2xs)] font-bold uppercase tracking-[0.15em] px-[var(--space-6)] py-[var(--space-4)] rounded-[var(--radius-lg)] shadow-[var(--shadow-lg)] active:scale-95 transition-transform"
          >
